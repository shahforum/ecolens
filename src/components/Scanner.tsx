            ...
            <div className="flex-1 relative rounded-[3rem] overflow-hidden bg-forest shadow-2xl border-4 border-white">
              ...
              <div className="absolute inset-0 pointer-events-none p-10 flex flex-col justify-between items-center">
                ...
                <div className="flex flex-col items-center">
                  <ScanLine
                    className={`w-12 h-12 ${isScanning ? "text-sage animate-pulse" : "text-white/30"}`}
                  />
                </div>
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div className="space-y-1">
                ...
                <h2 className="text-4xl font-bold text-forest tracking-tight">
                  {analysis.itemName}
                </h2>
              </div>
              <button
            ...
            <div className="space-y-12">
              ...
              <section className="p-6 bg-forest text-white rounded-2xl">
                ...
                <p className="text-sm leading-relaxed mb-4">
                  {analysis.instructions[WasteCategory.RECYCLE]}
                </p>
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <p className="text-[10px] text-forest/40 uppercase font-bold tracking-widest">
                      {h.date}
                    </p>
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 w-full mt-12">
              <div className="p-6 bg-forest rounded-3xl text-white text-center">
                <p className="text-[9px] font-bold uppercase text-sage mb-1">
                  Scanned
                </p>
                <p className="text-3xl font-bold">124</p>
              </div>
              <div className="p-6 bg-sage/10 rounded-3xl text-center border border-sage/20">
                <p className="text-[9px] font-bold uppercase text-forest/30 mb-1">
                  Impact
                </p>
...
function NavButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex flex-col items-center gap-1 flex-1 transition-colors ${active ? "text-forest" : "text-forest/30"}`}
    >
      {icon}
